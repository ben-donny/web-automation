...
WebUI.sendKeys(findTestObject('Efc/EfcLoginPage/UserName'), GlobalVariable.username)

WebUI.clearText(findTestObject('Efc/EfcLoginPage/Password'), FailureHandling.STOP_ON_FAILURE)

WebUI.sendKeys(findTestObject('Efc/EfcLoginPage/Password'), GlobalVariable.password)
